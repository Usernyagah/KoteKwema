    ...
    <div className="fixed inset-0 z-50 bg-background/98 backdrop-blur-sm animate-fade-in">
      <div className="container mx-auto px-6 lg:px-12 h-full flex flex-col">
        <div className="flex items-center justify-between h-20">
          <span className="text-sm tracking-wide text-muted-foreground">Search</span>
          <Button
            variant="ghost"
            size="icon"
            onClick={onClose}
          ...
          <div className="w-full max-w-4xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-transparent border-b border-border pb-4 pl-12 text-3xl md:text-5xl font-light focus:outline-none focus:border-foreground transition-colors duration-300"
                autoFocus
              />
            </div>
